...
public class Resources extends TableImpl<ResourcesRecord> {
    ...
    private static final long serialVersionUID = -736472500;
    /**
     ...
     */
    public final TableField<ResourcesRecord, Timestamp> LAST_TIME_COMPUTED = createField("last_time_computed", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");
    /**
