...
public class TempAccounts extends TableImpl<TempAccountsRecord> {
    ...
    private static final long serialVersionUID = -1775608736;
    ...
    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.ID</code>.
     */
    public final TableField<TempAccountsRecord, UShort> ID = createField("ID", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.LOGIN</code>.
     */
    public final TableField<TempAccountsRecord, String> LOGIN = createField("LOGIN", org.jooq.impl.SQLDataType.VARCHAR.length(20), this, "");

    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.PASSWORD</code>.
     */
    public final TableField<TempAccountsRecord, String> PASSWORD = createField("PASSWORD", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.EMAIL</code>.
     */
    public final TableField<TempAccountsRecord, String> EMAIL = createField("EMAIL", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.CHECK_VALUE</code>.
     */
    public final TableField<TempAccountsRecord, String> CHECK_VALUE = createField("CHECK_VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.DATE</code>.
     */
    public final TableField<TempAccountsRecord, Timestamp> DATE = createField("DATE", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>YILDIZDATABASE.TEMP_ACCOUNTS.COMPLETE</code>.
     */
    public final TableField<TempAccountsRecord, Boolean> COMPLETE = createField("COMPLETE", org.jooq.impl.SQLDataType.BIT, this, "");
     ...
     */
    @Override
    public Identity<TempAccountsRecord, UShort> getIdentity() {
        return Keys.IDENTITY_TEMP_ACCOUNTS;
    }
