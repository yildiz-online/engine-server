...
public class Keys {
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<TaskBuildBuildingRecord> KEY_TASK_BUILD_BUILDING_PRIMARY = createUniqueKey(TaskBuildBuilding.TASK_BUILD_BUILDING, "KEY_task_build_building_PRIMARY", TaskBuildBuilding.TASK_BUILD_BUILDING.ID);
        public static final UniqueKey<TaskBuildEntityRecord> KEY_TASK_BUILD_ENTITY_PRIMARY = createUniqueKey(TaskBuildEntity.TASK_BUILD_ENTITY, "KEY_task_build_entity_PRIMARY", TaskBuildEntity.TASK_BUILD_ENTITY.ID);
        public static final UniqueKey<TempAccountRecord> KEY_TEMP_ACCOUNT_PRIMARY = createUniqueKey(TempAccount.TEMP_ACCOUNT, "KEY_temp_account_PRIMARY", TempAccount.TEMP_ACCOUNT.LOGIN);
        public static final UniqueKey<WebLostPasswordRecord> KEY_WEB_LOST_PASSWORD_PRIMARY = createUniqueKey(WebLostPassword.WEB_LOST_PASSWORD, "KEY_web_lost_password_PRIMARY", WebLostPassword.WEB_LOST_PASSWORD.ID);
        public static final UniqueKey<WebNewsRecord> KEY_WEB_NEWS_PRIMARY = createUniqueKey(WebNews.WEB_NEWS, "KEY_web_news_PRIMARY", WebNews.WEB_NEWS.ID);
    }
}
