...
public class TaskBuildEntity extends TableImpl<TaskBuildEntityRecord> {
    ...
    private static final long serialVersionUID = -1204187712;
    /**
     * The column <code>yildizdatabase.task_build_entity.id</code>.
     */
    public final TableField<TaskBuildEntityRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaulted(true), this, "");
    /**
