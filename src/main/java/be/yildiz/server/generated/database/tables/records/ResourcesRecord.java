...
public class ResourcesRecord extends UpdatableRecordImpl<ResourcesRecord> implements Record8<UInteger, UInteger, Timestamp, Double, Double, Double, Double, Double> {

    private static final long serialVersionUID = -20772161;

    /**
     * Setter for <code>YILDIZDATABASE.RESOURCES.RES_ID</code>.
     */
    public void setResId(UInteger value) {
        set(0, value);
    }

    /**
     * Getter for <code>YILDIZDATABASE.RESOURCES.RES_ID</code>.
     */
    public UInteger getResId() {
        return (UInteger) get(0);
    }

    /**
     * Setter for <code>YILDIZDATABASE.RESOURCES.CIT_ID</code>.
     */
    ...
    /**
     * Getter for <code>YILDIZDATABASE.RESOURCES.CIT_ID</code>.
     */
     ...
     */
    @Override
    public Row8<UInteger, UInteger, Timestamp, Double, Double, Double, Double, Double> fieldsRow() {
     ...
     */
    @Override
    public Row8<UInteger, UInteger, Timestamp, Double, Double, Double, Double, Double> valuesRow() {
     ...
     */
    @Override
    public ResourcesRecord values(UInteger value1, UInteger value2, Timestamp value3, Double value4, Double value5, Double value6, Double value7, Double value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ResourcesRecord(UInteger resId, UInteger citId, Timestamp lastTimeComputed, Double metal, Double energy, Double money, Double research, Double inhabitant) {
        super(Resources.RESOURCES);
